...
Kullanıcı Arayüzü (UI) Taslakları: Kullanıcıların sisteme güvenli bir şekilde girmesi için "Giriş" (Login) ve "Kayıt Ol" (Registration) sayfalarının temelleri atılmıştır .